...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Футбольная, волейбольная, баскетбольная форма и беговые комплекты с полноцветной печатью. Любые тиражи, от 10 комплектов. Coolmax, влагоотводящие ткани.",
  path: "/sport",
});
...
const items = [
  ...
  },
  {
    ...
    description:
      "Единая форма для корпоративных турниров: с логотипом компании, номерами и именами. Работаем с тиражами от 10 комплектов.",
  },
  {
...
const advantages = [
  ...
  "Ткань Coolmax — сертифицированная влагоотводящая технология",
    "Производство от 10 комплектов — подходит для небольших команд",
...
const faqItems = [
  ...
  },
  {
    ...
    a: "От 10 комплектов. При тираже от 20–30 комплектов цена за единицу становится значительно ниже.",
  },
  {
        ...
        <div className="container-site">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg text-muted-text leading-relaxed">
              ...
              Индивидуальные номера без доплаты. От 10 комплектов.
            </p>
